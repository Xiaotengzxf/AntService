...
class CustomerAddViewController: UIViewController {
    ...
    @IBAction func save(_ sender: Any) {
        ...
        NetworkManager.installshared.request(type: .post, url: NetworkManager.installshared.appAddCust, params: ["customer" : name! , "mobile" : phone! , "address" : address , "remark" : remark]){
