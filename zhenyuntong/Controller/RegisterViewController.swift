...
//        }
        ...
        NetworkManager.installshared.request(type: .post, url: NetworkManager.installshared.null, params: ["userId" : userId , "nickName" : nick! , "account" : name! , "password" : DESHelper.encryptUseDES(pwd!) , "channel" : 1 , "mobile" : mobile! , "registType" : 1 , "userType" : 1 , "imei" : imei , "imsi" : imei]){ // imei imsi
